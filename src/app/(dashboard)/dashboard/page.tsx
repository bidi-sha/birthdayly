...
export default async function DashboardPage() {
  ...
  if (error) {
    return <div className="p-8 text-center text-red-500">Something went wrong loading your birthdays. Please try refreshing.</div>
  }
  ...
  return <DashboardClient birthdays={withPictures} greetingName={greetingName} />
}